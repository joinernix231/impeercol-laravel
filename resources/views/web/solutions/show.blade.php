        ...
        <div class="sol-hero__grid">
            ...
            <div>
                ...
                <div class="sol-hero__actions">
                    <a href="{{ $whatsappAdvisoryUrl }}" class="sol-btn-wa" target="_blank" rel="noopener noreferrer" data-conv>
    ...
    <div class="container">
        ...
        <div class="sol-problem-grid">
            ...
            <div class="sol-problem-card sol-reveal sol-reveal--delay-{{ $idx + 1 }}">
                ...
                @endif
                <a href="{{ $waMsg }}" class="sol-problem-card__btn" target="_blank" rel="noopener noreferrer" data-conv>
            ...
            <div class="sol-product-card sol-reveal">
                ...
                <div class="sol-product-card__body">
                    ...
                    <div class="sol-product-card__actions">
                        <a href="{{ $waProductSpecific }}" class="sol-btn-product sol-btn-product--wa" target="_blank" rel="noopener noreferrer" data-conv>
...
<section class="sol-section">
    <div class="container">
        ...
        <div class="text-center sol-reveal" style="margin-top:2.5rem;">
            <a href="{{ $whatsappAdvisoryUrl }}" class="sol-btn-wa" style="display:inline-flex;" target="_blank" rel="noopener noreferrer" data-conv>
...
<div class="sol-cta-final">
    <div class="container position-relative" style="z-index:1;">
        ...
        <a href="{{ $waFinalUrl }}" class="sol-btn-cta-final" target="_blank" rel="noopener noreferrer" data-conv>
