                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control variant-image-input" name="variants[0][image]" placeholder="Ruta de la imagen o sube una nueva">
                                            <button type="button" class="btn btn-outline-secondary btn-upload-variant-image" data-variant-index="0">
                                                <i class="bi bi-upload"></i> Subir
                                            </button>
                                        </div>
                                        <div class="variant-image-preview mt-2" data-variant-index="0"></div>
                                    </div>
                                    <div class="col-md-2">
