...
@section('title', 'Crear Banner - Admin')
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('subtitle') is-invalid @enderror" id="subtitle" name="subtitle" rows="2" maxlength="500">{{ old('subtitle') }}</textarea>
