...
@section('title', 'Crear Artículo de Blog - Admin')
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control @error('thumbnail') is-invalid @enderror" id="thumbnail" name="thumbnail" value="{{ old('thumbnail') }}" placeholder="Ruta del thumbnail o sube una nueva">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('video_url') is-invalid @enderror" id="video_url" name="video_url" value="{{ old('video_url') }}" placeholder="https://www.youtube.com/watch?v=... o https://vimeo.com/...">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('featured_quote') is-invalid @enderror" id="featured_quote" name="featured_quote" rows="2" maxlength="500" placeholder="Una frase importante o cita destacada del artículo">{{ old('featured_quote') }}</textarea>
                        <small class="form-text text-muted">Máximo 500 caracteres</small>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('tips') is-invalid @enderror" id="tips" name="tips" rows="4" placeholder="Consejos prácticos, tips o recomendaciones importantes">{{ old('tips') }}</textarea>
                        @error('tips')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('difficulty') is-invalid @enderror" id="difficulty" name="difficulty">
                                ...
                                <option value="básico" {{ old('difficulty') == 'básico' ? 'selected' : '' }}>Básico</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('estimated_time') is-invalid @enderror" id="estimated_time" name="estimated_time" value="{{ old('estimated_time') }}" placeholder="Ej: 2-3 horas, 1 día">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('materials') is-invalid @enderror" id="materials" name="materials" rows="3" placeholder="Lista de materiales necesarios para el proyecto">{{ old('materials') }}</textarea>
                        @error('materials')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('tools') is-invalid @enderror" id="tools" name="tools" rows="3" placeholder="Lista de herramientas necesarias para el proyecto">{{ old('tools') }}</textarea>
                        @error('tools')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('tags') is-invalid @enderror" id="tags" name="tags" value="{{ old('tags') }}" placeholder="Separar por comas: tag1, tag2, tag3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('reading_time') is-invalid @enderror" id="reading_time" name="reading_time" value="{{ old('reading_time') }}" min="1" max="120" placeholder="Se calcula automáticamente si se deja vacío">
...
@push('scripts')
    ...
    <script>
        ...
        // Script para subir imagen principal
