...
/**
 * ============================================
 * FORM REQUEST: BlogStoreRequest
 * ============================================
 * 
 * Valida los datos al crear un nuevo artículo de blog.
 * Solo usuarios con rol 'admin' pueden crear artículos.
 */
class BlogStoreRequest extends BaseFormRequest
{
    /**
